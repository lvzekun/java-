...
<body>
<form action="Registerform.actoin" id="Registerform" name="Registerform" method="post" target="_self">
	<table>
<!--用户名和密码 -->		
		<tr class="grey" >
	...
	<tr>
		...
		<tr>
			...
			<td style="width: 250px">
				<input type="password" id="UserPsd" name="UserPsd" style="width: 200px"/>
				<span style="position: relative;bottom: -4px ">*</span>
			</td>
			<td>
...
<!--用户信息 -->
		<tr>
			<td colspan="3" class="grey">
				<span style="color:black;font-size: 17px;">用户信息</span>
			</td>
		</tr>
		<tr>
			<td style="text-align: left;">
			...
			<td style="width: 250px">
				<input type="text" id="UserTrue" name="UserTrue" style="width: 200px"/>
				<span style="position: relative;bottom: -4px ">*</span>
			</td>
			<td>
				<span>请填写中华人民共和国居民身份证上的名字(不可更改)</span>
			</td>
		</tr>
		<tr>
			<td style="text-align: left;">
			...
			<td>
				<span>请填写中华人民共和国居民身份证号(不可更改)</span>
			</td>
		</tr>
		<tr>
			<td style="text-align: left;">
			...
			<td style="width: 250px">
				<input type="text" id="UserEmail" name="UserEmail" style="width: 200px"/>
				<span style="position: relative;bottom: -4px ">*</span>
			</td>
			<td>
				<span>非常重要，个人邮箱，用于修改用户密码及相关信息</span>
			</td>
		</tr>
		<tr>
			<td style="text-align: left;">
			...
			<td style="width: 250px">
				<input type="text" id="UserPhone" name="UserPhone" style="width: 200px"/>
				<span style="position: relative;bottom: -4px ">*</span>
			</td>
			<td>
