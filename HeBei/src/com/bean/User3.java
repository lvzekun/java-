...
/**
 * User3 entity. @author MyEclipse Persistence Tools
 */
...
public class User3  implements java.io.Serializable {
	...
	/** minimal constructor */
    public User3(Integer id, String TName, String TTime1, String TTime2, String TIntroduction1, String TIntroduction2, String TIntroduction3, String TKey0, String TAllmoney, String TTypeYf, String TType2, String TXqjsssly) {
        this.id = id;
        this.TName = TName;
        this.TTime1 = TTime1;
        this.TTime2 = TTime2;
        this.TIntroduction1 = TIntroduction1;
        this.TIntroduction2 = TIntroduction2;
        this.TIntroduction3 = TIntroduction3;
        this.TKey0 = TKey0;
        this.TAllmoney = TAllmoney;
        this.TTypeYf = TTypeYf;
        this.TType2 = TType2;
        this.TXqjsssly = TXqjsssly;
    }
    
    /** full constructor */
    public User3(Integer id, String TName, String TTime1, String TTime2, String TIntroduction1, String TIntroduction2, String TIntroduction3, String TKey0, String TKey1, String TKey2, String TKey3, String TKey4, String TAllmoney, String TTypeYf, String TDanwei, String TType2, String TList, String TList2, String TList3, String TXqjsssly, String TQtjsms, String TQtjsms2, String TQtjsms3) {
        this.id = id;
        this.TName = TName;
        this.TTime1 = TTime1;
        this.TTime2 = TTime2;
        ...
        this.TAllmoney = TAllmoney;
        this.TTypeYf = TTypeYf;
        this.TDanwei = TDanwei;
        this.TType2 = TType2;
        this.TList = TList;
        this.TList2 = TList2;
        this.TList3 = TList3;
        this.TXqjsssly = TXqjsssly;
        this.TQtjsms = TQtjsms;
        this.TQtjsms2 = TQtjsms2;
        this.TQtjsms3 = TQtjsms3;
    }
